...
We measured the voltage at two points in a resistor network to validate the behavior of the circuit. We found the ratio of voltages was: $0.6646\pm 0.0012$ close to the expected value of $0.6667$. We also measured the decay over time of the voltage on a capacitor. We used that to estimate the decay time constant and found that to be $\tau = 67.21\pm -0.29\mathrm{~ms}$, very close to the expected value of $\tau =66.67\mathrm{~ms}$.
...
We performed two experiments 1. measurements on a voltage divider to validate the value of the ratio of the bottom resistor to the whole network and 2. to measure the time constant of an RC network.  We found the ratio of voltages for the voltage divider was: $0.6646\pm 0.0012$ close to the expected value of $0.6667$. We found the time constant of the RC circuit to be $tau = 67.21 \pm -0.29\mathrm{~ms}$, very close to the expected value of $66.67\mathrm{~ms}$.

The goal of this project was to become famiar with all the tools we'll be using this semester in Laboratory Instrumentation and to make some real measurements, and analyze some real data. One recommendation I have to someone else doing this project is to make sure that the connection is solid before reading for data. This was a mistake we unfortunately made.
